...
//         >
//           <div className="rounded-lg flex py-2 pl-2 -mx-1 bg-gray-100 dark:bg-neutral-800/40 items-center gap-2">
...
//             </div>
//             <div>
//               <h2 className="font-semibold text-xs text-black dark:text-white">{activity.name}</h2>
//               <p className="text-gray-700 dark:text-neutral-100/90 font-medium text-xs max-w-[250px] md:max-w-md truncate ">
//                 {activity.details}
//               </p>
//               <p className="text-gray-600 dark:text-neutral-100/70 font-medium  text-xs ">
//                 {activity.state}
//               </p>
//             </div>
//           </div>
